...
import com.github.flyhero.toolbox.pojo2json.parser.type.*;
...
public abstract class POJO2JSONParser {
	 ...
	 * @param ignoreProperties 过滤的属性，这个参数只在这里使用 {@link com.github.flyhero.toolbox.pojo2json.parser.POJO2JSONParser#parseField}
	 *                         用于过滤用户指定移除的属性
